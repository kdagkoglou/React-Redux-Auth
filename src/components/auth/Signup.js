    ...
    return (
      <form onSubmit={handleSubmit(this.onSubmit)}>
        <fieldset>
          ...
          <Field name="first_name" type="text" component="input" placeholder="First Name" />
        </fieldset>
        <fieldset>
          <label htmlFor="last_name">Last Name</label>
          <Field name="last_name" type="text" component="input" placeholder="Last Name" />
        </fieldset>
        <fieldset>
        ...
        <fieldset>
          ...
          <Field name="role" type="text" component="select">
            <option value=""></option>
